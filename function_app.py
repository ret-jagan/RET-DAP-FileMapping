...
def http_trig_mapping(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Python HTTP trigger function processed a request.')
    
    api_url = "https://pag-api-dev.4seeanalytics.com/api/fileworkflow/submission/datafor/validationjob"
    if not api_url:
